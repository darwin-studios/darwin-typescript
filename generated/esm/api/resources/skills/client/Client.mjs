...
export class SkillsClient {
    ...
    __listAiSkills(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `ais/${core.url.encodePathParam(aiId)}/skills`),
                method: "GET",
                headers: _headers,
    ...
    __deleteAiSkill(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `ais/${core.url.encodePathParam(aiId)}/skills/${core.url.encodePathParam(skillId)}`),
                method: "DELETE",
                headers: _headers,
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                timeoutMs: ((_f = (_d = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _d !== void 0 ? _d : (_e = this._options) === null || _e === void 0 ? void 0 : _e.timeoutInSeconds) !== null && _f !== void 0 ? _f : 60) * 1000,
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/ais/{aiId}/skills/{skillId}");
        });
    }
    /**
     ...
     *     })
     */
    updateAiSkill(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__updateAiSkill(request, requestOptions));
    }
    __updateAiSkill(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const { aiId, skillId } = request, _body = __rest(request, ["aiId", "skillId"]);
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `ais/${core.url.encodePathParam(aiId)}/skills/${core.url.encodePathParam(skillId)}`),
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/ais/{aiId}/skills/{skillId}");
        });
    }
}
