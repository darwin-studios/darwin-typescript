...
export declare class ConnectionsClient {
     ...
     *     })
     */
    listAiConnections(request: Darwin.ListAiConnectionsRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ListAiConnectionsResponse>;
     ...
     *     })
     */
    createConnectionAssignment(request: Darwin.CreateConnectionAssignmentRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.CreateConnectionAssignmentResponse>;
     ...
     *     })
     */
    revokeConnectionAssignment(request: Darwin.RevokeConnectionAssignmentRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.RevokeConnectionAssignmentResponse>;
     ...
     *     })
     */
    createConnectionAuthorizationSession(request: Darwin.CreateConnectionAuthorizationRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ConnectionAuthorizationSession>;
     ...
     *     })
     */
    completeConnectionAuthorizationSession(request: Darwin.CompleteConnectionAuthorizationRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ConnectionAuthorizationCompletion>;
     ...
     *     })
     */
    disableConnectionGrant(request: Darwin.DisableConnectionGrantRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ConnectionGrantDisableResult>;
     ...
     *     })
     */
    removeAiConnection(request: Darwin.RemoveAiConnectionRequest, requestOptions?: ConnectionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ConnectionRemovalResult>;
