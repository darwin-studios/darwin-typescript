...
export declare class TasksClient {
     ...
     */
    listTasks(request?: Darwin.ListTasksRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.ListTasksResponse>;
    private __listTasks;
    /**
     * @deprecated
     *
     ...
     *     })
     */
    createTask(request: Darwin.CreateTaskRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.CreateTaskResponse>;
     ...
     *     })
     */
    getTask(request: Darwin.GetTaskRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.GetTaskResponse>;
    private __getTask;
    /**
     * @deprecated
     *
     ...
     *     })
     */
    updateTask(request: Darwin.UpdateTaskBody, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.UpdateTaskResponse>;
     ...
     *     })
     */
    actOnTask(request: Darwin.ActOnTaskRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.ActOnTaskResponse>;
    private __actOnTask;
    /**
     * @deprecated
     *
     ...
     *     })
     */
    requestTaskPublicationApproval(request: Darwin.RequestTaskPublicationApprovalRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.ApprovalResult>;
     ...
     *     })
     */
    requestTaskPublication(request: Darwin.RequestTaskPublicationRequest, requestOptions?: TasksClient.RequestOptions): core.HttpResponsePromise<Darwin.PublicationRequestResult>;
