...
export declare class TransactionsClient {
     ...
     *     })
     */
    createDealTransaction(request: Darwin.CreateTransactionFundingRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.TransactionFundingResult>;
     ...
     */
    listTransactions(request?: Darwin.ListTransactionsRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ListTransactionsResponse>;
     ...
     *     })
     */
    getTransaction(request: Darwin.GetTransactionRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.GetTransactionResponse>;
     ...
     *     })
     */
    getTransactionAccountRequirement(request: Darwin.GetTransactionAccountRequirementRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.GetTransactionAccountRequirementResponse>;
     ...
     *     })
     */
    actOnTransaction(request: Darwin.TransactionActionRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.ActOnTransactionResponse>;
     ...
     *     })
     */
    authorizeTransactionPayment(request: Darwin.ApplicationPaymentAuthorizationRequest, requestOptions?: TransactionsClient.RequestOptions): core.HttpResponsePromise<Darwin.AuthorizeTransactionPaymentResponse>;
