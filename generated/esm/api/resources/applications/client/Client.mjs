...
export class ApplicationsClient {
    ...
    __archiveApplication(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/applications/{applicationId}");
        });
    }
    /**
    ...
    __updateApplication(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/applications/{applicationId}");
        });
    }
    /**
    ...
    __getApplicationMonetization(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `applications/${core.url.encodePathParam(applicationId)}/monetization`),
                method: "GET",
                headers: _headers,
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                timeoutMs: ((_f = (_d = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _d !== void 0 ? _d : (_e = this._options) === null || _e === void 0 ? void 0 : _e.timeoutInSeconds) !== null && _f !== void 0 ? _f : 60) * 1000,
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/applications/{applicationId}/monetization");
        });
    }
    /**
    ...
    __updateApplicationMonetization(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/applications/{applicationId}/monetization");
        });
    }
    /**
    ...
    __resolveApplicationUser(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `applications/${core.url.encodePathParam(applicationId)}/users/resolve`),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/applications/{applicationId}/users/resolve");
        });
    }
    /**
    ...
    __listApplicationAIs(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/applications/{applicationId}/ais");
        });
    }
    /**
    ...
    __linkApplicationAi(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/applications/{applicationId}/ais");
        });
    }
    /**
    ...
    __unlinkApplicationAi(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/applications/{applicationId}/ais/{aiId}");
        });
    }
    /**
    ...
    __listEnrollmentLinks(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/applications/{applicationId}/enrollment-links");
        });
    }
    /**
    ...
    __createEnrollmentLink(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/applications/{applicationId}/enrollment-links");
        });
    }
    /**
    ...
    __revokeEnrollmentLink(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/applications/{applicationId}/enrollment-links/{enrollmentLinkId}");
        });
    }
    /**
    ...
    __getApplicationWallet(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/applications/{applicationId}/wallet");
        });
    }
    /**
    ...
    __fundApplicationWallet(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/applications/{applicationId}/wallet/transfers");
        });
    }
    /**
    ...
    __listServiceAccounts(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/applications/{applicationId}/service-accounts");
        });
    }
    /**
    ...
    __createServiceAccount(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/applications/{applicationId}/service-accounts");
        });
    }
    /**
    ...
    __revokeServiceAccount(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/applications/{applicationId}/service-accounts/{serviceAccountId}");
        });
    }
}
