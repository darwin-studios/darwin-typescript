...
export class OutcomesClient {
     ...
     */
    listOutcomes(request = {}, requestOptions) {
    ...
    __listOutcomes() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, "outcomes"),
                method: "GET",
                headers: _headers,
    ...
    __getOutcome(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _headers = mergeHeaders(_authRequest.headers, (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `outcomes/${core.url.encodePathParam(outcomeId)}`),
                method: "GET",
                headers: _headers,
     ...
     *     })
     */
    submitOutcomeEvidence(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__submitOutcomeEvidence(request, requestOptions));
    }
    __submitOutcomeEvidence(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j;
            const { outcomeId, "Idempotency-Key": idempotencyKey } = request, _body = __rest(request, ["outcomeId", "Idempotency-Key"]);
            const _authRequest = yield this._options.authProvider.getAuthRequest();
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_c = (_b = (yield core.Supplier.get(this._options.baseUrl))) !== null && _b !== void 0 ? _b : (yield core.Supplier.get(this._options.environment))) !== null && _c !== void 0 ? _c : environments.DarwinEnvironment.Production, `outcomes/${core.url.encodePathParam(outcomeId)}/evidence`),
                method: "POST",
                headers: _headers,
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/outcomes/{outcomeId}/evidence");
        });
    }
}
