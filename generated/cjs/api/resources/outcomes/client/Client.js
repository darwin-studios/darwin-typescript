...
class OutcomesClient {
  ...
  __submitOutcomeEvidence(request, requestOptions) {
    return __awaiter(this, void 0, void 0, function* () {
      var _a, _b, _c, _d, _e, _f, _g, _h, _j;
      const { outcomeId, 'Idempotency-Key': idempotencyKey } = request,
        _body = __rest(request, ['outcomeId', 'Idempotency-Key']);
      const _authRequest = yield this._options.authProvider.getAuthRequest();
      const _headers = (0, headers_js_1.mergeHeaders)(
        _authRequest.headers,
        (_a = this._options) === null || _a === void 0 ? void 0 : _a.headers,
...
exports.OutcomesClient = OutcomesClient;
