...
function evaluateRuntime() {
  ...
  const isCloudflare =
    ...
    ((_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.navigator) === null || _a === void 0
      ? void 0
      : _a.userAgent) === 'Cloudflare-Workers';
  if (isCloudflare) {
    return {
      type: 'workerd',
    };
  ...
  const isNode =
    ...
    typeof ((_g = _process.versions) === null || _g === void 0 ? void 0 : _g.node) === 'string';
  if (isNode) {
    return {
      type: 'node',
...
function getUserAgent(sdkName, sdkVersion) {
  ...
  const platform = [exports.RUNTIME.os, normalizeArch(exports.RUNTIME.arch)].filter(
