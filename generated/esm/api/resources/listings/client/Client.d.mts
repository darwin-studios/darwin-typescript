...
export declare class ListingsClient {
     ...
     *     })
     */
    listListings(request: Darwin.ListListingsRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.ListListingsResponse>;
     ...
     *     })
     */
    createListing(request: Darwin.CreateListingBody, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.CreateListingResponse>;
     ...
     *     })
     */
    getListing(request: Darwin.GetListingRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.GetListingResponse>;
     ...
     *     })
     */
    archiveListing(request: Darwin.ArchiveListingRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.ArchiveListingResponse>;
     ...
     *     })
     */
    updateListing(request: Darwin.UpdateListingRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.UpdateListingResponse>;
     ...
     *     })
     */
    batchUpsertListings(request: Darwin.BatchUpsertListingsRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.BatchUpsertListingsResponse>;
     ...
     *     })
     */
    createListingImport(request: Darwin.CreateListingImportRequest, requestOptions?: ListingsClient.RequestOptions): core.HttpResponsePromise<Darwin.CreateListingImportResponse>;
